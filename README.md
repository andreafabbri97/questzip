...
- [x] 🇮🇹 Compendio in italiano dai manuali ufficiali — **chiuso** (vedi `scripts/ita-compendio/`): incantesimi (Manuale del Giocatore, Tasha, Xanathar), mostri (6 manuali, filtrati voce per voce incrociando i dati con l'inglese), razze (le 9 del Manuale del Giocatore, sottorazze incluse) e classi (dado vita/competenze/equipaggiamento per tutte e 12, tabella di progressione completa per 8/12 — trovato che l'estrazione geometrica delle tabelle, basata sulle coordinate dei caratteri e non sul testo lineare, funziona: le 4 classi incantatrici principali hanno colonne extra per gli slot incantesimo che rompono il rilevamento, lavoro futuro). Fuori scope confermato: oggetti magici (il PHB non ne contiene, solo il DMG), Manuale del DM (font offuscato, 2110 sotto-insiemi di font distinti, servirebbe OCR dei singoli glifi — progetto a sé sul livello del Mastrino), "Oggetti Magici (Dm e Book of many things).pdf" (risultato in inglese via OCR), Regole principali/Costa della Spada (OCR italiano pronto e funzionante, ma contenuto di tipo regole-generali/lore che non rientra in nessuna categoria esistente del Compendio).
