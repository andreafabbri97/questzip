...
- [ ] 🇮🇹 Compendio in italiano dai manuali ufficiali: fatto per incantesimi (Manuale del Giocatore, Tasha, Xanathar), mostri (Manuale dei Mostri) e razze (le 9 del Manuale del Giocatore, sottorazze incluse), via pipeline di estrazione testo in `scripts/ita-compendio/` (vedi sotto). Provati anche Mostri del Multiverso/Fizban/Bigby/Dragonlance/Van Richten per i mostri, ma scartati dopo l'incrocio con i dati inglesi (formato tipografico troppo diverso, troppi errori) — richiedono lavoro dedicato per libro. Restano da coprire classi e oggetti magici.
