...
- [ ] 🇮🇹 Compendio in italiano dai manuali ufficiali: fatto per incantesimi (Manuale del Giocatore) e mostri (Manuale dei Mostri), via pipeline di estrazione testo in `scripts/ita-compendio/` (vedi sotto). Restano da coprire classi/razze/oggetti magici e gli altri manuali (Tasha, Xanathar, Van Richten, Fizban, Bigby, Dragonlance, Mostri del Multiverso).
