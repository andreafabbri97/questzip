...
- **🗺️ Campagne** — condivise: accedi con Google, crea una campagna (diventi master), invita amici con un link/codice, assegna il ruolo master/giocatore a ciascun membro, diario delle sessioni condiviso. Dati su database (Postgres/Neon), non più solo sul dispositivo.
...
- [ ] 🔗 Collegare i Personaggi (oggi locali) alle Campagne condivise
